...
function small_img_widget() {register_widget( 'small_img_cat_sci1' );}

class small_img_cat_sci1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'small_img_category_sci1', // Widget ID
			__('Small featured images', 'science-magazine'), //Name
...
<div id="small-wrapper">
	<ul class="small-category">
		<?php if($review) {$sci1_posts = new WP_Query(array(  'tax_query' => array(array('taxonomy' => 'post_format', 'field' => 'slug', 'terms' => array('post-format-aside'))),'posts_per_page' => $number, 'offset' => $offset ));}
		else
