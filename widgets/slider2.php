...
add_action( 'widgets_init', 'slider2_widget' );

function slider2_widget() {register_widget( 'slider_sci1s2' );}

class slider_sci1s2 extends WP_Widget {

	/* Register widget with WordPress. */

	function __construct() {
		parent::__construct(
				'slider_widget_sci1s2', 	//Widget ID
				__('Slider2', 'science-magazine'), // Name
		...
		public function widget( $args, $instance ) {
			...
			$defaults = array( 'title' => 'Image Slider', 'number' => 3, 'slider_control' => 'on', 'widget_size' => 'one-part', 'categories' => 0,'tags' => 0, 'subtitle'=>'on');
