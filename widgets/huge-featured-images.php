...
function huge_img_feat_widget() {register_widget( 'huge_img_feat_cat_sci1' );}

class huge_img_feat_cat_sci1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'huge_img_featured_category_sci1', // Widget ID
			__('Huge Featured Images', 'science-magazine'),  //Name
	...
	<ul class="img-featured">
		...
		<li <?php post_class((is_sticky()?'sticky':'')); ?>>
			<div class="img-featured-posts-image">
				...
				<?php the_post_thumbnail('hugeimagefeatured');if ( 'video' == get_post_format() ): echo '<span class="play-icon"></span>';endif;  ?>
				</a>
				<?php } else {?>
				<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
