...
function ad_widget() {register_widget( 'ad_widget_sci1' );}

class ad_widget_sci1 extends WP_Widget {
	
	/* Register widget with WordPress. */
	
	function __construct() {
		parent::__construct(
			'ad_widget_sizes_sci1', // Widget ID
			__('Ad Widget', 'science-magazine'), // Name
...
<div class="ad-widget-sizes">
	<?php if (!empty($link) || !empty($text) || !empty($image)){?>
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>">
		<?php _e('Image url:', 'science-magazine'); ?>
	</label>
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'link' )); ?>">
		<?php _e('Link to:', 'science-magazine'); ?>
	</label>
...
<p>
	<label for="<?php echo esc_attr($this->get_field_id( 'text' )); ?>">
		<?php _e('Code text(alternative way, just leave image and link empty and paste the code here):', 'science-magazine'); ?>
	</label>
