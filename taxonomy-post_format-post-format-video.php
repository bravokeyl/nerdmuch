	...
	if ($id_post == ''){
		...
		<div class="tv-video-wrapper">
			<div class="embed-wrapper">
				<?php echo wp_oembed_get(get_post_meta($postID, "sci1_video_link", true), array('width'=>1008, 'autoplay' => '1') ); ?>
			</div>
			<!--tv-page-video-wrapper-->
			<div class="share-tv">
				<div class="share-tv-title">
					<?php echo esc_html(get_option('sci1_share_this_video')); ?>
				</div>
				<ul>
					<li>
		...
		<div class="tv-page-widget home-widget four-parts">
			<h3>
				...
				<?php echo esc_html(get_option('sci1_tv_carousel_title')); ?>
				</span>
			</h3>
